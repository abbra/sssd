...
{
    const char *attrs[] = {
        rfc2307_autofs_entry_map[SDAP_OC_AUTOFS_ENTRY].name,
        /* SDAP_AT_AUTOFS_ENTRY_KEY missing on purpose, its value was
         * the same between the wrong and correct schema
         */
        rfc2307_autofs_entry_map[SDAP_AT_AUTOFS_ENTRY_VALUE].name,
        rfc2307_autofs_mobject_map[SDAP_OC_AUTOFS_MAP].name,
        rfc2307_autofs_mobject_map[SDAP_AT_AUTOFS_MAP_NAME].name,
        NULL,
    };
